...
import {useRelatedProductDetails} from "./useRelatedProductDetails";
import ItemLists from "../Component/Horizontal/List/ItemLists";
import FloatBoxes from "../Component/Float/FloatBoxes";
import Grids from "../Component/Horizontal/Grid/Grids";
import HorizontalDisplay from "../Component/Horizontal/HorizontalDisplay";
import {useRelatedCart} from "../Cart/useRelatedCartPage";
...
const ProductFullDetail = props => {
    ...
    // maybe a big hook for all this?
    const before_content_talons = useRelatedProductDetails({
        sku: sku,
        location: 'before-content'
    })

    const after_content_talons = useRelatedProductDetails({
        sku: sku,
        location: 'after-content'
    })

    const replace_related_talons = useRelatedProductDetails({
        sku: sku,
        location: 'replace-related'
    })

    const replace_upsell_talons = useRelatedProductDetails({
        sku: sku,
        location: 'replace-upsell'
    })

    const before_related_talons = useRelatedProductDetails({
        sku: sku,
        location: 'before-related'
    })

    const after_related_talons = useRelatedProductDetails({
        sku: sku,
        location: 'after-related'
    })

    const before_upsell_talons = useRelatedProductDetails({
        sku: sku,
        location: 'before-upsell'
    })

    const after_upsell_talons = useRelatedProductDetails({
        sku: sku,
        location: 'after-upsell'
    })

    const left_popup_talons = useRelatedProductDetails({
        sku: sku,
        location: 'left-popup-content'
    })

    const right_popup_talons = useRelatedProductDetails({
        sku: sku,
    ...
    return (
        <Fragment>
            ...
            <HorizontalDisplay {...before_related_talons}/>
            <HorizontalDisplay {...replace_related_talons}/>
            <HorizontalDisplay {...after_related_talons}/>
