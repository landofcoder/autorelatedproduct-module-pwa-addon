...
import {useRelatedCheckout} from "./useRelatedCheckoutPage";
...
const CheckoutPage = props => {
    ...
    const before_content_talons = useRelatedCheckout({
        location: 'before-content',
    })

    const after_content_talons = useRelatedCheckout({
        location: 'after-content',
    })

    const left_popup_talons = useRelatedCheckout({
        location: 'left-popup-content',
    })

    const right_popup_talons = useRelatedCheckout({
